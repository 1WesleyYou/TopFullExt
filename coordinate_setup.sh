...
tmux new-session -d -s topfull-proxy "ulimit -n 65536 || true; cd '${src_dir}/proxy' && go build -o proxy_online_boutique proxy_online_boutique.go && ./proxy_online_boutique"
